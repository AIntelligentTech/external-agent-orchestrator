...
echo ""
echo "  # Test with Gemini (FREE)"
echo "  /gemini Describe a modern button component"
echo ""
echo "  # Architecture with Codex"
echo "  /codex:xhigh Design a scalable microservices architecture"
echo ""
echo "  # Code generation with OpenCode"
echo "  /opencode:haiku Write a debounce utility function"
echo ""
echo -e "For more examples, see: ${BLUE}https://github.com/YOUR_USERNAME/external-agent-orchestrator${NC}"
echo ""
