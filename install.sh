...
echo ""
echo "  # Codex - Architecture with reasoning"
echo "  /codex:gpt-5.2:high Design microservices for 10M users"
echo ""
echo "  # Gemini - Design (FREE)"
echo "  /gemini:gemini-3-pro Create a dark mode design system"
echo ""
echo "  # OpenCode - Code generation"
echo "  /opencode:opus-4.5:extended Implement real-time WebSocket system"
echo "  /opencode:haiku-4.5 Write a debounce utility function"
echo ""
